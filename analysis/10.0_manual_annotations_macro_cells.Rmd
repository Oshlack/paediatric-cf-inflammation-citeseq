...
seuInt@meta.data %>%
  ggplot(aes(x = ann_level_2, fill = Status_sub)) +
...
if(!file.exists(out)){
  ...
  entrez <- ann_level_2Dbi::mapIds(org.Hs.eg.db,
...
#   rownames_to_column(var = "cell") %>%
#   pivot_longer(c(-ann_level_2, -cell), 
#                names_to = "ADT",
#                values_to = "expression") %>%
#   dplyr::group_by(ann_level_2, ADT) %>%
