...
```{r}
pdf(here("output","pdf_figures","Figure_6.pdf"), width = 7, height = 9)
fig6
dev.off()
```
...
<!-- library(ggplot2) -->
<!-- library(patchwork) -->
<!-- library(cowplot)   # alignment -->
<!-- library(grid)      # unit() -->
<!-- library(here) -->

<!-- # Example plots (your real p1, p2, p3, ... here) -->
<!-- # p1 <- ... -->
<!-- # p2 <- ... -->
<!-- # p3 <- ... -->

<!-- # 1) Align (hv = both directions; axis = which sides must line up) -->
<!-- aligned <- align_plots(p1, p2, align = "h", axis = "l") -->

<!-- # 2) Rebuild as ggplots (now with harmonised widths) -->
<!-- p1a <- ggplotify::as.ggplot(aligned[[1]]) -->
<!-- p2a <- ggplotify::as.ggplot(aligned[[2]]) -->
...
<!--   plot_annotation( -->
<!--     tag_levels = "A", -->
<!--     theme = theme(plot.tag = element_text(size = 48, face = "bold", family = "Arial")) -->
<!--   ) -->

<!-- ggsave( -->
<!--   filename = "Figure_6.pdf", -->
<!--   plot = fig, -->
<!--   path = here("output", "pdf_figures"), -->
