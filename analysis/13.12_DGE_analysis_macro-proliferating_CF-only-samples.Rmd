...
subtitle: "DGE analysis of macro-proliferating: CF modifier and severity"
...
Extract only the *macro-proliferating* cells. 
...
# Statistical analysis with `RUVseq` {.tabset}
