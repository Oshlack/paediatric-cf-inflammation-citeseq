...
subtitle: "Cell type proportions analysis - broad labels"
...
# seuLst[1:2] <- lapply(seuLst[1:2], function(s){
#   s@meta.data %>%
#     mutate(ann_level_2 = Annotation) %>%
#     dplyr::rename("ann_level_1" = "Broad",
#                   "ann_level_3" = "Annotation") -> s@meta.data
#   s
# })
