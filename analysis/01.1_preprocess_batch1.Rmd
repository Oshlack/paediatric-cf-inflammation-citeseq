---
title: "Demultiplexing the C133_Neeland_batch1 data set"
description: |
author:
...
<!-- ```{r, fig.asp=0.8} -->
<!-- plotDecontXContamination(sce_decont) -->
<!-- ``` -->
...
<!-- cell_type_mappings <- list(Tcells = "2", Bcells = "5", Macrophages = "1", Epithelial = "4") -->

<!-- plotDecontXMarkerPercentage(sce_decont, -->
<!--                             markers = markers, -->
